...
static void printConfig(IdxType i_proc, const std::string &sim_backend) {
  if (i_proc == 0) {
    ...
    std::cout << std::left << std::setw(40) << "\033[1;33mSim Trace:\033[0m"
              << "\033[1;32m" << (PRINT_SIM_TRACE ? "Enabled" : "Disabled")
              << "\033[0m" << std::endl;
    std::cout << std::left << std::setw(40) << "\033[1;33mFusion:\033[0m"
              << "\033[1;32m" << (ENABLE_FUSION ? "Enabled" : "Disabled")
              << "\033[0m" << std::endl;
    std::cout << std::left << std::setw(40) << "\033[1;33mNoise:\033[0m"
              << "\033[1;32m" << (ENABLE_NOISE ? "Enabled" : "Disabled")
              << "\033[0m" << std::endl;
    std::cout << std::left << std::setw(40) << "\033[1;33mTensor Core:\033[0m"
              << "\033[1;32m" << (ENABLE_TENSOR_CORE ? "Enabled" : "Disabled")
              << "\033[0m" << std::endl;
    std::cout << std::left << std::setw(40)
              << "\033[1;33mSimulation Backend:\033[0m" << "\033[1;32m";
    if (sim_backend == "DM")
      std::cout << "DMSim";
