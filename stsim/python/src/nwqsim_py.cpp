...
void bind_single_qubit_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
  ...
  auto binder = [method](NWQSim::Circuit &self,
                         IdxType qubit) -> NWQSim::Circuit & {
    (self.*method)(qubit);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("qubit"),
          py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("qubit"),
          py::return_value_policy::reference_internal);
}
...
void bind_multi_target_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                            const char *name, Method method) {
  auto binder =
      [method](NWQSim::Circuit &self,
               const std::vector<IdxType> &targets) -> NWQSim::Circuit & {
    (self.*method)(targets);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def((lower_name + "_multi").c_str(), binder, py::arg("qubits"),
          py::return_value_policy::reference_internal);
  cls.def((std::string(name) + "_MULTI").c_str(), binder, py::arg("qubits"),
          py::return_value_policy::reference_internal);
}
...
void bind_control_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                       const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, IdxType control,
                         IdxType target) -> NWQSim::Circuit & {
    (self.*method)(control, target);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("control"), py::arg("target"),
          py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("control"), py::arg("target"),
          py::return_value_policy::reference_internal);
}
...
void bind_angle_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                     const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, ValType theta,
                         IdxType qubit) -> NWQSim::Circuit & {
    (self.*method)(theta, qubit);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("theta"), py::arg("qubit"),
          py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("theta"), py::arg("qubit"),
          py::return_value_policy::reference_internal);
}
...
void bind_three_angle_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                           const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, ValType theta, ValType phi,
                         ValType lam, IdxType qubit) -> NWQSim::Circuit & {
    (self.*method)(theta, phi, lam, qubit);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("theta"), py::arg("phi"),
          py::arg("lam"), py::arg("qubit"),
          py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("theta"), py::arg("phi"), py::arg("lam"),
          py::arg("qubit"), py::return_value_policy::reference_internal);
}

template <typename Method>
void bind_two_angle_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                         const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, ValType first, ValType second,
                         IdxType qubit) -> NWQSim::Circuit & {
    (self.*method)(first, second, qubit);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("phi"), py::arg("lam"),
          py::arg("qubit"), py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("phi"), py::arg("lam"), py::arg("qubit"),
          py::return_value_policy::reference_internal);
}
...
void bind_control_angle_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                             const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, ValType theta, IdxType control,
                         IdxType target) -> NWQSim::Circuit & {
    (self.*method)(theta, control, target);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("theta"), py::arg("control"),
          py::arg("target"), py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("theta"), py::arg("control"), py::arg("target"),
          py::return_value_policy::reference_internal);
}
...
void bind_two_qubit_angle_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                               const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, ValType theta, IdxType q0,
                         IdxType q1) -> NWQSim::Circuit & {
    (self.*method)(theta, q0, q1);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("theta"), py::arg("qubit_a"),
          py::arg("qubit_b"), py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("theta"), py::arg("qubit_a"),
          py::arg("qubit_b"), py::return_value_policy::reference_internal);
}
...
void bind_noise_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                     const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, IdxType qubit, ValType param_a,
                         ValType param_b) -> NWQSim::Circuit & {
    (self.*method)(qubit, param_a, param_b);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("qubit"), py::arg("param_a"),
          py::arg("param_b"), py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("qubit"), py::arg("param_a"),
          py::arg("param_b"), py::return_value_policy::reference_internal);
}
...
void bind_single_param_noise(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                             const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, IdxType qubit,
                         ValType param) -> NWQSim::Circuit & {
    (self.*method)(qubit, param);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("qubit"), py::arg("param"),
          py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("qubit"), py::arg("param"),
          py::return_value_policy::reference_internal);
}
...
void bind_control_noise_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                             const char *name, Method method) {
  auto binder = [method](NWQSim::Circuit &self, IdxType target, IdxType control,
                         ValType param) -> NWQSim::Circuit & {
    (self.*method)(target, control, param);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder, py::arg("target"), py::arg("control"),
          py::arg("param"), py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("target"), py::arg("control"), py::arg("param"),
          py::return_value_policy::reference_internal);
}
...
void bind_probability_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                           const char *name, Method method) {
  auto binder_single =
      [method](NWQSim::Circuit &self, IdxType qubit,
               const std::vector<double> &probabilities) -> NWQSim::Circuit & {
    (self.*method)(qubit, probabilities);
    return self;
  };
  std::string lower_name = to_lower(name);
  cls.def(lower_name.c_str(), binder_single, py::arg("qubit"),
          py::arg("probabilities"),
          py::return_value_policy::reference_internal);
  cls.def(name, binder_single, py::arg("qubit"), py::arg("probabilities"),
          py::return_value_policy::reference_internal);
}
...
void bind_control_probability_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls,
                                   const char *name, Method method) {
  auto binder =
      [method](NWQSim::Circuit &self, IdxType target, IdxType control,
               const std::vector<double> &probabilities) -> NWQSim::Circuit & {
  ...
  cls.def(lower_name.c_str(), binder, py::arg("target"), py::arg("control"),
          py::arg("probabilities"),
          py::return_value_policy::reference_internal);
  cls.def(name, binder, py::arg("target"), py::arg("control"),
          py::arg("probabilities"),
          py::return_value_policy::reference_internal);
}

void bind_mod_noise(py::class_<NWQSim::Circuit, CircuitPtr> &cls) {
  auto binder = [](NWQSim::Circuit &self, const std::string &op,
                   const std::string &noise, ValType value,
                   const std::vector<IdxType> &qubits) -> NWQSim::Circuit & {
    self.MOD_NOISE(op, noise, value, qubits);
    return self;
  };
  cls.def("mod_noise", binder, py::arg("operation"), py::arg("noise_model"),
          py::arg("value"), py::arg("qubits"),
          py::return_value_policy::reference_internal);
  cls.def("MOD_NOISE", binder, py::arg("operation"), py::arg("noise_model"),
          py::arg("value"), py::arg("qubits"),
          py::return_value_policy::reference_internal);
...
void bind_comb_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls) {
  auto binder = [](NWQSim::Circuit &self, IdxType qubit, ValType phi,
                   ValType lambda, ValType gamma) -> NWQSim::Circuit & {
    self.COMB(qubit, phi, lambda, gamma);
    return self;
  };
  cls.def("comb", binder, py::arg("qubit"), py::arg("phi"), py::arg("lambda"),
          py::arg("gamma"), py::return_value_policy::reference_internal);
  cls.def("COMB", binder, py::arg("qubit"), py::arg("phi"), py::arg("lambda"),
          py::arg("gamma"), py::return_value_policy::reference_internal);
}

void bind_cu_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls) {
  auto binder = [](NWQSim::Circuit &self, ValType theta, ValType phi,
                   ValType lam, ValType gamma, IdxType control,
                   IdxType target) -> NWQSim::Circuit & {
    self.CU(theta, phi, lam, gamma, control, target);
    return self;
  };
  cls.def("cu", binder, py::arg("theta"), py::arg("phi"), py::arg("lam"),
          py::arg("gamma"), py::arg("control"), py::arg("target"),
          py::return_value_policy::reference_internal);
  cls.def("CU", binder, py::arg("theta"), py::arg("phi"), py::arg("lam"),
          py::arg("gamma"), py::arg("control"), py::arg("target"),
          py::return_value_policy::reference_internal);
...
void bind_ccx_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls) {
  auto binder = [](NWQSim::Circuit &self, IdxType a, IdxType b,
                   IdxType c) -> NWQSim::Circuit & {
    self.CCX(a, b, c);
    return self;
  };
  cls.def("ccx", binder, py::arg("control_1"), py::arg("control_2"),
          py::arg("target"), py::return_value_policy::reference_internal);
  cls.def("CCX", binder, py::arg("control_1"), py::arg("control_2"),
          py::arg("target"), py::return_value_policy::reference_internal);
}
...
void bind_cswap_gate(py::class_<NWQSim::Circuit, CircuitPtr> &cls) {
  auto binder = [](NWQSim::Circuit &self, IdxType control, IdxType a,
                   IdxType b) -> NWQSim::Circuit & {
    self.CSWAP(control, a, b);
    return self;
  };
  cls.def("cswap", binder, py::arg("control"), py::arg("qubit_a"),
          py::arg("qubit_b"), py::return_value_policy::reference_internal);
  cls.def("CSWAP", binder, py::arg("control"), py::arg("qubit_a"),
          py::arg("qubit_b"), py::return_value_policy::reference_internal);
}
...
void bind_measure_all(py::class_<NWQSim::Circuit, CircuitPtr> &cls) {
  ...
  cls.def("measure_all", binder, py::arg("shots"),
          py::return_value_policy::reference_internal);
  cls.def("MA", binder, py::arg("shots"),
          py::return_value_policy::reference_internal);
}
...
PYBIND11_MODULE(nwqsim, m) {
  ...
  py::class_<NWQSim::CircuitMetrics>(m, "CircuitMetrics")
      ...
      .def_readonly("retention_lifespan",
                    &NWQSim::CircuitMetrics::retention_lifespan)
      .def_readonly("measurement_density",
                    &NWQSim::CircuitMetrics::measurement_density)
      .def_readonly("entanglement_variance",
                    &NWQSim::CircuitMetrics::entanglement_variance);
  ...
  auto circuit = py::class_<NWQSim::Circuit, CircuitPtr>(m, "Circuit")
                     ...
                     .def("reset", &NWQSim::Circuit::reset,
                          py::return_value_policy::reference_internal)
                     .def("clear", &NWQSim::Circuit::clear,
                          py::return_value_policy::reference_internal)
  ...
  bind_multi_target_gate(
      circuit, "H",
      static_cast<void (NWQSim::Circuit::*)(const std::vector<IdxType> &)>(
          &NWQSim::Circuit::H));
  bind_multi_target_gate(
      circuit, "S",
      static_cast<void (NWQSim::Circuit::*)(const std::vector<IdxType> &)>(
  ...
  bind_control_gate(circuit, "CX",
                    static_cast<void (NWQSim::Circuit::*)(IdxType, IdxType)>(
                        &NWQSim::Circuit::CX));
  ...
  py::class_<NWQSim::QuantumState, StatePtr>(m, "QuantumState")
      ...
      .def("measurement_results",
           [](StatePtr &state) { return state->get_measurement_results(); })
      .def(
          "print_config",
           ...
           [](StatePtr &state) {
             if (state->sim_type != NWQSim::SimType::SV) {
               throw std::runtime_error(
                   "statevector() is only available for statevector backends");
             }
             ...
             if (!real || !imag) {
               throw std::runtime_error(
                   "backend does not expose amplitude buffers");
             }
             const size_t dim = static_cast<size_t>(1ULL << num_qubits);
             py::array_t<std::complex<double>> out(dim);
             auto *data =
                 reinterpret_cast<std::complex<double> *>(out.mutable_data());
             for (size_t i = 0; i < dim; ++i) {
               data[i] = std::complex<double>(real[i], imag[i]);
             }
             return out;
           })
      .def("num_qubits", [](StatePtr &state) { return state->get_qubits(); })
      .def(
          "expectation_z",
          ...
          py::arg("bits"))
      .def("expectation_z", [](StatePtr &state) { return state->get_exp_z(); })
      .def_readonly("sim_type", &NWQSim::QuantumState::sim_type);

  m.def(
      "create_state",
      [](const std::string &backend, IdxType num_qubits,
  ...
  m.def(
      ...
      py::arg("path"), py::arg("num_qubits") = -1);
  ...
  m.def(
      ...
      py::arg("text"), py::arg("num_qubits") = -1);
  ...
  config.def("set_print_sim_trace",
             [](bool value) { NWQSim::Config::PRINT_SIM_TRACE = value; });
  config.def("set_enable_noise",
             [](bool value) { NWQSim::Config::ENABLE_NOISE = value; });
  config.def("set_enable_fusion",
             [](bool value) { NWQSim::Config::ENABLE_FUSION = value; });
  config.def("set_random_seed",
             [](int value) { NWQSim::Config::RANDOM_SEED = value; });
  config.def("set_tensor_core",
             [](bool value) { NWQSim::Config::ENABLE_TENSOR_CORE = value; });
